...
class ProfileBusCompanyScreen extends StatefulWidget {
  const ProfileBusCompanyScreen({super.key});

  @override
  State<ProfileBusCompanyScreen> createState() =>
      _ProfileBusCompanyScreenState();
}

class _ProfileBusCompanyScreenState extends State<ProfileBusCompanyScreen> {
  Uint8List? _image;
